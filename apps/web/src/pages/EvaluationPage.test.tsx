...
describe('EvaluationPage metrics', () => {
  ...
  it('derives comparison outcomes from the fixture', async () => {
    ...
    expect(within(comparison).getByText('126')).toBeInTheDocument()
    expect(within(comparison).getByText('118')).toBeInTheDocument()
    expect(within(comparison).getByText('8')).toBeInTheDocument()
  ...
  it('derives status and review reason counts from the fixture', async () => {
    ...
    expect(within(status).getByText('512')).toBeInTheDocument()
    expect(within(status).getByText('8')).toBeInTheDocument()
    ...
    expect(within(status).getAllByText('2')).toHaveLength(2)
