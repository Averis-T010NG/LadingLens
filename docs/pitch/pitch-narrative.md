...
| Peak | “`SYN-042` is expected, due and has no matching case.” | Expected row beside an empty case match and `MISSING_CASE`. | “The second control found absence without waiting for another email.” |
...
| Product screens | Captures of inbox accounting, evidence comparison, refusal, `SYN-042`, review ownership and public judge route | Slides and video |
