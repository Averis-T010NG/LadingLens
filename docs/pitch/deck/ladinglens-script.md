...
> accounted for: four hundred and fifty-seven clean, forty-six flagged,
> seventeen refused.
>
...
-   **Setup:** slide 4 establishes that the ledger is independent of the inbox
    and that `SYN-042` has an expectation. Do not resolve it there.
...
-   **Follow-through:** pair it immediately with the seventeen refusals, so the
...
| 457 / 46 / 17 | 9 | Prepared seed baseline, organisers' synthetic bundle |
| `SYN-042` -> `MISSING_CASE` | 9 | Gate 2 reconciliation |
