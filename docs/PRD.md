...
`SHP-5RFR-37631`, reconciled as `MISSING_CASE` without an email case.
...
| FR-09 | Exhibit reconciliation states. Acceptance: the preliminary build must visibly show a matched case, a missing document, and `SHP-5RFR-37631` as `MISSING_CASE`.                                                                                                                                                                       | `apps/api/app/`, `apps/web/src/`, `data/sdoc-hackathon-bundle/`                                         |
