# Graph Report - averis  (2026-09-22)

## Corpus Check
- 421 files · ~815,464 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 58 file(s) not represented in the graph (top: .css 40, (none) 11, .lock 3)

## Summary
- 5142 nodes · 13419 edges · 282 communities (248 shown, 22 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1518 edges (avg confidence: 0.94)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ed62c3ce`
...
1. `PersistenceService` - 234 edges
2. `ComparedField` - 165 edges
3. `InMemoryPrivateObjectStore` - 118 edges
4. `SeedCatalog` - 109 edges
5. `DocumentRole` - 86 edges
6. `AuditContext` - 86 edges
7. `vitest` - 70 edges
8. `Category` - 66 edges
9. `get_settings()` - 65 edges
10. `ComparisonPipeline` - 59 edges
...
## Communities (282 total, 22 thin omitted)
...
Cohesion: 0.11
Nodes (44): _submission_json(), build_submission_artifact(), AsyncClient, model_validator, Self, StrEnum, ValueError, score_submission_artifact() (+36 more)
...
### Community 18 - "graph_chat.py"
Cohesion: 0.07
Nodes (51): The control graph: a bounded view for the canvas, and grounded chat., _adjacency(), build_corpus(), flag_id(), ChatRequest, _Citation, _cited_subgraph(), _contents() (+43 more)

### Community 19 - "review-queue/seam.ts"
Cohesion: 0.05
Nodes (54): CaseReviewTarget, ReconciliationExceptionActionType, ReconciliationExceptionReviewTarget, ReviewAssignment, ReviewAssignmentState, ReviewHistoryEntry, PREPARED_FIXTURES, cloneRecord() (+46 more)
...
### Community 25 - "seam-api.ts"
Cohesion: 0.10
Nodes (44): CATEGORIES, COMPARED_FIELDS, createApiEmailDetailService(), DOCUMENT_TYPES, EmailDetailContractError, fail(), fallsBackOnAction(), isAbortError() (+36 more)
...
### Community 32 - "ControlTrace.tsx"
Cohesion: 0.10
Nodes (29): StatusGlyph(), CaseRow(), ControlTrace(), ControlTraceProps, documentName(), documentState(), EntityProps, Filter (+21 more)
...
### Community 38 - "main"
Cohesion: 0.12
Nodes (19): artifact_path(), _gemini_metadata(), _gemini_resolved_endpoint(), _git_short_sha(), _jev_metadata(), main(), _parse_args(), AttachmentInput (+11 more)
...
Cohesion: 0.25
Nodes (8): 0:00–0:30 — Account for the inbox, 0:30–1:00 — Show exact submission output, 1:00–1:40 — Prove a judge-supplied document comparison, 1:40–2:05 — Refuse an unsafe comparison, 2:05–2:35 — Load the independent expectation ledger, 2:35–3:55 — Peak: reveal the unmatched expected shipment, 3:55–4:50 — Close on ownership and the public route, Five-minute preliminary run
...
### Community 59 - "judge/types.ts"
Cohesion: 0.10
Nodes (24): Category, ComparedField, ComparisonGrid(), FieldVerdictRecord, FailurePanel(), FailurePanelProps, BL_DOC, SI_DOC (+16 more)

### Community 60 - "test_jev.py"
Cohesion: 0.19
...
Cohesion: 0.16
Nodes (43): FieldVerdictRecord, ComparisonPipeline, Compare a BL_READY case's SI/draft-BL pair and record the verdict., FailingEquivalence, Raises instead of judging, like a Jev equivalence provider timeout., _ambiguous_bl_case(), _audit(), _boom_generate() (+35 more)
...
### Community 64 - "GraphChatPanel.tsx"
Cohesion: 0.10
Nodes (25): GraphEdgeKind, GraphNodeKind, ChatEntry, SuggestionChips(), SuggestionChipsProps, answerToHighlight(), corpusToControlGraph(), getGraphCorpus() (+17 more)

### Community 65 - "email-detail/types.ts"
Cohesion: 0.05
Nodes (49): AttachmentPreflightList(), AttachmentPreflightListProps, DOC_TYPE_LABEL, formatBytes(), PARSE_STATUS_MAP, PARSE_TEXT_MAP, REFUSAL_EXPLANATIONS, REFUSAL_TITLES (+41 more)
...
Cohesion: 0.05
Nodes (45): DropZone(), onDrop(), takeFiles(), DropZoneProps, DropZoneRejectionReason, FieldRow(), FieldRowProps, formatCeiling() (+37 more)

### Community 72 - "test_benchmark_latency.py"
Cohesion: 0.11
Nodes (28): build_artifact(), nearest_rank(), The nearest-rank quantile: rank = max(1, min(n, ceil(q * n))). Always an…, n/p50/p95/max per stage over non-warmup trials whose stage succeeded. Each…, Assemble the full JSON-serializable artifact for one benchmark run. `completed`…, Total/prompt/candidates token counts from a response's usage_metadata. None…, summarize(), _token_usage() (+20 more)

### Community 73 - "contracts.ts"
Cohesion: 0.04
Nodes (72): AmbiguousReconciliation, CaseReviewAction, ExpectedShipment, MissingCaseReconciliation, ReconciliationBase, ReconciliationExceptionReviewAction, ReconciliationOutcome, ReconciliationResult (+64 more)

### Community 74 - "formats.py"
Cohesion: 0.08
Nodes (43): DigitalPdfLocation, DigitalPdfProvenance, DocxParagraphLocation, DocxProvenance, DocxTableLocation, Provenance, _ProvenanceIdentity, TxtLocation (+35 more)
...
### Community 77 - "AppShell.tsx"
Cohesion: 0.08
Nodes (25): ThemeSeed(), hexToRgb(), SilkCanvas(), SilkCanvasProps, FakeResizeObserver, mountSized(), paintsAcrossGap(), putImageData (+17 more)
...
### Community 79 - "test_integration_matrix.py"
Cohesion: 0.13
...
Cohesion: 0.14
Nodes (34): PairAnalyzed, One trial's extraction stages. `analyses` is the product's real `(si, bl)`…, The pipeline status end_to_end and the TrialRecord both report. Derived from…, Run `warmup` discarded trials then `trials` measured ones, sequentially. Every…, run_benchmark(), StageRecord, _trial_status(), _check() (+26 more)
...
Cohesion: 0.07
Nodes (25): lifespan(), FastAPI, Response, Scope, Static files with fallback to index.html for client-side routes., Warm the shared seed catalog and close the live provider client. A broken…, SPAStaticFiles, _clean_seed_catalog_state() (+17 more)

### Community 89 - "GeminiCallError"
Cohesion: 0.09
Nodes (40): _clients(), GeminiCallError, GeminiNotConfigured, generate(), generate_traced(), generate_with_backoff(), Exception, RuntimeError (+32 more)

### Community 90 - "Overlays.tsx"
Cohesion: 0.09
Nodes (24): addDays(), addMonths(), ClipTooltip(), ClipTooltipProps, ConfirmDialog(), ConfirmDialogProps, DatePicker(), onKeyDown() (+16 more)
...
### Community 92 - "test_api_judge.py"
Cohesion: 0.15
Nodes (49): build_judge(), The judge service over the comparison pipeline and these providers., _anchored_text(), client(), _Equivalence, _gemini_reads_values_not_in_the_text(), _GeminiResponse, _guest() (+41 more)
...
### Community 94 - "persistence.py"
Cohesion: 0.09
Nodes (23): ReviewActionRecord, CachedExtractionEntry, CacheWriteResult, _case_review_status(), CaseDocuments, CaseReviewActionRecord, _default_audit_writer(), DocumentRoleSnapshot (+15 more)

### Community 95 - "judge-api.ts"
Cohesion: 0.15
Nodes (18): createJudgeRun(), CreateJudgeRunInput, getGateSummary(), getJudgePolicy(), getJudgeRun(), getPreparedFallback(), isUploadRejection(), JudgeUploadError (+10 more)

### Community 96 - "asyncio"
Cohesion: 0.42
Nodes (10): The product's real GeminiExtractor, timing each labeled scan call and capturing…, _TimingGeminiExtractor, asyncio, test_timing_gemini_extractor_http_status_is_none_on_success(), test_timing_gemini_extractor_records_http_status_on_failure(), test_timing_gemini_extractor_records_key_attempts_on_failure(), test_timing_gemini_extractor_records_key_attempts_on_success(), test_timing_gemini_extractor_records_token_usage_on_a_scan() (+2 more)
...
### Community 99 - "test_formats.py"
Cohesion: 0.08
Nodes (57): _col(), _docx_document(), _docx_paragraph_document(), _docx_row_document(), _only(), _page_image(), _paragraph(), _parse() (+49 more)

### Community 100 - "JevProviderFailure"
Cohesion: 0.13
Nodes (8): _JevNotWired, Jev before its provider client is wired: every check fails closed., AsyncSystemOneClient, JevFailureCode, JevProviderFailure, StrEnum, A provider failure with safe context for persistence and retry policy., _FailingClassifier

### Community 101 - "JudgeView.tsx"
Cohesion: 0.11
Nodes (29): PreparedFallbackPanel(), defaultJudgeApi, JudgeApiClient, outcomeHeadline(), classifyError(), clearStoredRunId(), documentRoleLabel(), findDocumentByAttachmentId() (+21 more)
...
### Community 103 - "react"
Cohesion: 0.05
Nodes (58): Button(), ButtonProps, CheckboxProps, CheckboxState, Field(), FieldControlProps, FieldProps, FieldTriggerProps (+50 more)

### Community 104 - "submission.py"
Cohesion: 0.14
Nodes (17): EvaluatorOutput, field_validator, model_validator, Self, serialize_evaluator_output(), EndToEndScore, _FrozenModel, _output_for_snapshot() (+9 more)

### Community 105 - "comparison.py"
Cohesion: 0.10
Nodes (41): band(), _check_values(), compare_fields(), _deterministic_reason(), _diagnostic(), equivalence_questions(), FieldDraft, PairAdmission (+33 more)

### Community 106 - "web/package.json"
Cohesion: 0.10
Nodes (19): name, private, type, version, @fontsource-variable/archivo, @fontsource-variable/geist, @fontsource-variable/geist-mono, @fontsource-variable/martian-mono (+11 more)

### Community 107 - "UploadPanel.tsx"
Cohesion: 0.12
Nodes (28): DropZoneRejection, baseName(), BatchPolicy, BatchReadError, decodeBase64(), entriesOf(), extension(), findDocument() (+20 more)
...
### Community 110 - "bind_request_context"
Cohesion: 0.11
Nodes (37): _content_disposition(), _file_response_headers(), inline_file_response(), get, GuestDep, Request, Response, SeedCatalogDep (+29 more)

### Community 112 - "test_jev_equivalence.py"
Cohesion: 0.15
...
Cohesion: 0.17
Nodes (7): fake_chatterbox_modules(), FakeRenderer, load_speak(), NonFiniteRenderer, SpeakBatchTests, factory(), factory()

### Community 115 - "deps.py"
Cohesion: 0.08
Nodes (43): build_services(), get_graph_chat(), get_judge(), get_materializer(), get_seed_catalog(), get_services(), Request, SeedCatalogDep (+35 more)
...
Cohesion: 0.09
Nodes (38): AuditContext, _canonical_json(), _expected_shipment_values(), IdempotencyConflict, _judge_attempt_payload(), JudgeAttempt, _payload_hash(), PersistenceService (+30 more)
...
Cohesion: 0.17
Nodes (21): JevDocumentRoleClient, Ask Jev which document each attachment is, judged only by its text. One…, RoleDocument, _answer(), _fake_sdk(), _FakeChoice, _FakeRetryPolicy, _FakeSystemOneClient (+13 more)

### Community 123 - "Settings"
Cohesion: 0.09
Nodes (30): Settings, load_seed_catalog(), The process-wide seed catalog, built once on first use. A build that fails is…, The seed catalog's build state, without starting or waiting on one., seed_status(), MonkeyPatch, Path, `cp .env.example .env` must leave every unset field at its default. (+22 more)
...
### Community 139 - "models.py"
Cohesion: 0.16
Nodes (30): _created_at_column(), DocumentRoleDecisionRecord, EmailAttachment, _enum(), GuestSession, JudgeRunRecord, datetime, StrEnum (+22 more)

### Community 140 - "test_deployment_hardening.py"
Cohesion: 0.20
Nodes (15): Convert a postgres:// URL (e.g. from Neon) to an asyncpg DSN. asyncpg rejects…, _to_asyncpg_dsn(), do_run_migrations(), run_async_migrations(), run_migrations_online(), _read(), test_ci_runs_postgresql_tests_instead_of_skipping_them(), test_ci_runs_web_tests_before_building() (+7 more)
...
Cohesion: 0.15
Nodes (27): _receipt_input(), AttachmentInput, receipt_request_hash(), ReceiptInput, _always_hangs(), _audit(), _create_workspace(), _FakeGeminiResponse (+19 more)
...
Cohesion: 0.21
Nodes (31): get_settings(), ChatTurn, GraphChatService, The ≤ ``limit`` nodes lexically closest to the question, with the edges that…, Answers one question against the corpus, or refuses it honestly., retrieve(), catalog(), _model_answer() (+23 more)
...
### Community 158 - "observability.py"
Cohesion: 0.12
Nodes (25): configure_event_logging(), emit_event(), install_observability(), BaseHTTPMiddleware, Exception, FastAPI, JSONResponse, Request (+17 more)

### Community 159 - "graph-chat-api.ts"
Cohesion: 0.19
Nodes (11): GRAPH, ControlGraph, GraphEdge, GraphHighlight, GraphNode, CorpusMeta, GraphAssistant, GraphAssistantContext (+3 more)
...
Cohesion: 0.10
Nodes (36): AttachmentInput, CachedExtraction, DocumentAnalyzer, _scan(), ExtractionFailureCode, StrEnum, LiveAnalyzer, Drives the product's real `DocumentAnalyzer` for one SI/draft-BL pair. (+28 more)

### Community 162 - "test_api_wiring.py"
Cohesion: 0.19
Nodes (15): _clean_settings(), client(), _guest(), AsyncClient, asyncio, fixture, MonkeyPatch, postgres (+7 more)

### Community 163 - "ApiProblem"
Cohesion: 0.11
Nodes (32): CaseActionBody, ExceptionActionBody, _named_reviewer(), BaseModel, GuestDep, MaterializerDep, post, Request (+24 more)

### Community 164 - "ExtractionFailure"
Cohesion: 0.06
Nodes (28): _call_failure(), ExtractionFailure, GeminiOutcome, _per_day_quota(), APIError, Exception, Whether a 429 names a per-day quota; per-minute ones are rate limits. Every…, A fail-closed extraction outcome that must surface as retry or review. (+20 more)

### Community 165 - "Post-auth structure"
Cohesion: 0.18
Nodes (10): Motion, Page frame, Post-auth structure, Route map, See also, Shared surfaces, Shell, Theme (+2 more)

### Community 166 - "JudgeView.test.tsx"
Cohesion: 0.12
Nodes (20): BL_DOC, CONSIGNEE_FIELD, CONSIGNEE_SI_PROVENANCE, createFakeApi(), DOCUMENT_ID_BY_FILE_NAME, dropFiles(), FALLBACK, file() (+12 more)

### Community 167 - "test_reconciliation.py"
Cohesion: 0.24
Nodes (17): expected_shipment_to_input(), ExpectedShipment, load_expected_shipments_csv(), parse_expected_shipments_csv(), Bridge a validated CSV row to the durable persistence contract., Parse a complete synthetic ledger or reject it without partial output., _csv_text(), parametrize (+9 more)
...
### Community 169 - "test_api_actions.py"
Cohesion: 0.09
Nodes (67): Services, BundleEmail, canonical_message_bytes(), BaseModel, field_validator, guest_case_id(), guest_reconciliation_id(), _message_bytes() (+59 more)

### Community 170 - "BatchPanel.tsx"
Cohesion: 0.14
Nodes (12): Checkbox(), Batch, BatchEntry, BatchItem, BatchItemStatus, describeError(), useBatchRun(), start() (+4 more)
...
### Community 172 - "test_api_reads.py"
Cohesion: 0.10
Nodes (48): list_emails(), get, GuestDep, MaterializerDep, Request, SeedCatalogDep, read_email(), read_summary() (+40 more)

### Community 173 - "vitest"
Cohesion: 0.04
Nodes (46): App(), KeyedRoutes(), options, css, useGraphAssistant(), FloatingAssistant(), css, combined (+38 more)
...
Cohesion: 0.11
Nodes (29): GeminiDocument, test_gemini_resolved_endpoint_reads_the_constructed_clients_base_url(), fake_generate_traced(), fake_generate_traced(), fake_generate_traced(), _answer(), _field(), _labelled() (+21 more)

### Community 177 - "judge.py"
Cohesion: 0.10
Nodes (32): field_verdict_view(), GuestContext, _already_succeeded(), _check_errors(), fallback(), JudgeService, _latency_ms(), _message_bytes() (+24 more)
...
Cohesion: 0.18
Nodes (41): admit_pair(), ReviewReason, DocumentRole, is_scan_hold(), Whether the diagnostics hold a compared scan rather than refuse a pair. A pair…, _check(), _container_admission(), _corrupt() (+33 more)

### Community 183 - "CheckWaiting.tsx"
Cohesion: 0.17
Nodes (18): CheckWaiting(), CheckWaitingProps, headline(), RANKS, STATE_LABEL, FILES, WaitingVerdict, formatFileSize() (+10 more)

### Community 184 - "test_comparison_persistence.py"
Cohesion: 0.24
Nodes (33): comparison_output(), structural_output(), ReviewActionInput, build_bl_ready_case(), Persist the given SI/BL attachments and classify the case BL_READY. Defaults to…, _audit_context(), _case_assignment_states(), _create_workspace() (+25 more)

### Community 185 - "test_gate1.py"
Cohesion: 0.21
Nodes (13): InboxIngestionService, Receipt an inbox before running fail-closed Gate 1 classification., JevClassification, _audit(), _IncompleteClassifier, _load_organizer_inbox(), _MemoryInbox, asyncio (+5 more)
...
### Community 190 - "_run_live"
Cohesion: 0.15
Nodes (12): _jev_resolved_endpoint(), The base URL the constructed typesafe-sdk client actually resolved to. Read…, Runs into `records` and `meta` (both mutated in place, so a caller keeps every…, _run_live(), analyzer_factory(), TrialRecord, Reproduces the reported bug: the committed artifact's started_at_utc (and file…, test_main_stamps_started_at_utc_with_the_runs_start_not_its_finish() (+4 more)
...
### Community 192 - "GraphPage.test.tsx"
Cohesion: 0.15
Nodes (5): ANSWER, CORPUS, GraphAssistantProvider(), ANSWER, LIVE_CORPUS

### Community 193 - "dependencies"
Cohesion: 0.18
Nodes (11): dependencies, @fontsource-variable/archivo, @fontsource-variable/geist, @fontsource-variable/geist-mono, @fontsource-variable/martian-mono, @hugeicons/core-free-icons, @hugeicons/react, mp4box (+3 more)
...
### Community 196 - "CaseReviewStatus"
Cohesion: 0.18
...
### Community 198 - "admincn and Geist"
Cohesion: 0.09
Nodes (22): admincn and Geist, admincn badge, admincn card, admincn component patterns, admincn header, admincn layout shell, admincn page frame, admincn progress, skeleton and waiting (+14 more)
...
### Community 200 - "test_api_graph_chat.py"
Cohesion: 0.15
Nodes (20): client(), generate(), _Guests, AsyncClient, fixture, GET /api/graph/corpus and POST /api/graph/chat over the seeded graph. The…, Resolves any presented token; the chat tests need no database., record() (+12 more)
...
### Community 202 - "@hugeicons/react"
Cohesion: 0.12
Nodes (9): LandingNav(), SITE_LINKS, SiteAnchorProps, SiteLink, SITE, footReveal(), SiteFooter(), SiteShell() (+1 more)

### Community 203 - "seed_catalog.py"
Cohesion: 0.08
Nodes (42): awaiting_output(), needs_interactive_review(), Whether the email's own message asks for the draft BL to be sent. Such an email…, A draft-BL request with nothing attached: nothing compared, no defect., requests_draft_bl(), Category, FieldVerdict, ReceivedEmail (+34 more)
...
### Community 206 - "EvaluationPage.tsx"
Cohesion: 0.12
Nodes (4): EvaluationPage(), OUTCOME_NOTE, brokenSource, pendingSource

### Community 208 - "label_field"
Cohesion: 0.20
...
Cohesion: 0.14
Nodes (13): Final integration checklist, Global Constraints, Landing And Auth Redesign Implementation Plan, Task 10: Verify in a browser and refresh the artefacts, Task 1: Add the film, silk and radius tokens, Task 2: Add the landing scroll math, Task 3: Add the WebCodecs frame bank, Task 4: Add the useVideoScrub loop (+5 more)

### Community 210 - "ReconciliationOutcome"
Cohesion: 0.33
Nodes (14): ReconciliationOutcome, Reconcile exact identifiers without choosing winners in conflicts., reconcile_shipments(), ReconciliationResultDraft, _case(), _shipment(), test_a_case_awaiting_its_draft_bl_is_present_without_documents(), test_ambiguity_preserves_sorted_candidate_sets_and_never_clears() (+6 more)

### Community 211 - "Motion"
Cohesion: 0.50
Nodes (4): Motion, Motion Rules, Motion Tokens, Reduced Motion

### Community 212 - "contracts.py"
Cohesion: 0.10
Nodes (29): _ContractModel, ExtractedValue, ExtractionResult, MissingCaseReconciliation, BaseModel, ReconciliationBase, ScannedPdfLocation, ScannedPdfProvenance (+21 more)

### Community 213 - "_answer_not_in_the_text"
Cohesion: 0.16
Nodes (9): _answer_not_in_the_text(), _CrashingRoleDecider, _FakeGeminiResponse, Raises a non-provider error for the attachments listed in crash_on., A schema-valid GeminiDocument JSON for a scanned SI/BL page., A schema-valid answer whose values the document's text does not contain., Answers the SI scan first and the BL scan second, both differing only by…, _scan_json() (+1 more)

### Community 214 - "Third-party notices"
Cohesion: 0.18
Nodes (10): API dependencies, Fonts and icons, mp4box licence text, Ported UI patterns, PyMuPDF licensing, Repository licence, Sources and verification, Synthetic dataset (+2 more)

### Community 215 - "LadingLens preliminary pitch deck — superseded planning draft"
Cohesion: 0.11
...
### Community 219 - "LadingLens architecture"
Cohesion: 0.14
...
### Community 221 - "reconciliation.py"
Cohesion: 0.19
Nodes (18): _candidate_component(), _canonical_timestamp(), DocumentKind, _normalize_identifier(), _parse_enum(), _parse_external_identifiers(), _parse_freshness(), _parse_required_documents() (+10 more)

### Community 222 - "ComparedField"
Cohesion: 0.15
Nodes (24): ComparedField, FieldCandidate, _head(), _label_ranges(), parse_document(), _parse_docx(), _parse_txt(), _parse_xlsx() (+16 more)
...
### Community 224 - "Workspace Redesign Design"
Cohesion: 0.12
Nodes (16): Accessibility, Decisions, Design read, Motion, Out of scope, Page header, Page restyles, Scope and isolation (+8 more)

### Community 225 - "Timed script"
Cohesion: 0.14
Nodes (14): 0:00-0:11 - Slide 1 - Cover, 0:11-0:50 - Slide 2 - The volume, 0:50-1:21 - Slide 3 - The blind spot, 1:21-1:46 - Slide 4 - Double entry, 1:46-2:06 - Slide 5 - Provenance, 2:06-2:32 - Slide 6 - Decision ownership, 2:32-2:51 - Slide 7 - Try it yourself, 2:51-3:03 - Slide 8 - Watch it run (+6 more)

### Community 226 - "LadingLens"
Cohesion: 0.15
Nodes (13): End-to-end workflow, Hackathon scope, LadingLens, LadingLens final-round extensions, LadingLens non-goals, LadingLens preliminary core, Originality, Problem statement (+5 more)

### Community 227 - "Demo runbook"
Cohesion: 0.14
...
### Community 228 - "SameStory"
Cohesion: 0.18
Nodes (11): Agreement rules, End-to-end workflow, Originality, Problem statement, Product promise, Real dataset demonstration, Risks and kill criteria, Rubric fit (+3 more)

### Community 229 - "api.ts"
Cohesion: 0.20
Nodes (13): TxtProvenance, SourceExcerpt(), SourceExcerptProps, API_SESSION_KEY, ApiError, apiFetch(), errorFrom(), forgetApiSession() (+5 more)

### Community 230 - "Timed script"
Cohesion: 0.18
Nodes (11): 0:00-0:30 - Slide 1 - The human capacity problem, 0:30-1:00 - Slide 2 - The cost of one miss, 1:00-1:30 - Slide 3 - Designed for the daily workload, 1:30-2:05 - Slide 4 - The mandatory second gate, 2:05-2:30 - Slide 5 - Inspectable accuracy, 2:30-2:45 - Slide 6 - Failure and decision ownership, 2:45-3:35 - Slide 7 - Find the case the inbox cannot see, 3:35-4:05 - Slide 8 - The honest implementation boundary (+3 more)

### Community 231 - "execute_gate_two"
Cohesion: 0.22
Nodes (13): ExpectedShipmentBatchResult, ReconciliationRunWriteResult, execute_gate_two(), GateTwoExecution, materialize_reconciliation_results(), Path, UUID, Give deterministic drafts immutable IDs and the exact persistence contract. (+5 more)

### Community 232 - "rgen.mjs"
Cohesion: 0.29
Nodes (5): [deck, out, maxArg, scaleArg], max, n, scale, playwright

### Community 233 - "LadingLens pitch deck script"
Cohesion: 0.20
Nodes (10): Evidence notes, Fallback language, LadingLens pitch deck script, Presentation contract, Primary proof moment, Rehearsal checklist, Runtime budget, See also (+2 more)

### Community 234 - "archive/README.md"
Cohesion: 0.31
Nodes (3): Archived preliminary proposal deck, What changed, Why it was replaced

### Community 235 - "SeedCatalog"
Cohesion: 0.09
Nodes (45): _held_review_evidence(), The one-line reason a case is held, and the probability driving it. A case is…, StrEnum, Status, The bundle bytes of one seed attachment; KeyError when unknown., SeedCatalog, build_catalog(), _json() (+37 more)

### Community 236 - "Final ideation comparison"
Cohesion: 0.25
Nodes (8): Candidate 1: LadingLens, Candidate 2: SameStory, Evaluation context, Final ideation comparison, Locked technology decision, Problem statement, Shared scope guardrails, The meaningful difference

### Community 237 - "Test-user selection scorecard"
Cohesion: 0.25
Nodes (8): First-reaction questions, Forced choice, Idea A: LadingLens, Idea B: SameStory, Problem summary for the test user, Scoring, Selection rule, Test-user selection scorecard

### Community 238 - "LadingLens proposal presentation script"
Cohesion: 0.25
Nodes (8): Evidence notes, Fallback language, LadingLens proposal presentation script, Presentation contract, Primary proof moment, Rehearsal checklist, See also, Transitions

### Community 239 - "make-qr.py"
Cohesion: 0.29
Nodes (6): lens(), octocat(), Deck QRs: the two links on the closing slide, each with its own mark in the…, The LadingLens mark: a ring whose closing arc is teal, on the deck's ink tile., GitHub's own mark on the same ink tile, so the pair reads as a pair., Image

### Community 240 - "LadingLens demo spine"
Cohesion: 0.25
Nodes (8): Finals additions, LadingLens demo spine, Model and decision ownership, Preliminary and finals cuts, Preliminary cut, Public judge path, Safe boundary, Source links
...
### Community 242 - "Independent subagent rubric audit"
Cohesion: 0.29
Nodes (7): Current-repository caveat, Final-round justifications, Final-round score forecast, Independent subagent rubric audit, Preliminary-round justifications, Preliminary-round score forecast, Raw reviewer totals

### Community 243 - "read_corpus"
Cohesion: 0.28
Nodes (9): chat(), get, GuestDep, post, Request, Scope, SeedCatalogDep, read_corpus() (+1 more)

### Community 244 - "Technology responsibilities"
Cohesion: 0.40
Nodes (5): Deterministic code, Gemini 3.5 Flash, Human reviewer, Jev, Technology responsibilities

### Community 245 - "Technology responsibilities"
Cohesion: 0.40
Nodes (5): Deterministic code, Gemini 3.5 Flash, Human reviewer, Jev, Technology responsibilities

### Community 246 - "Slide 11 — What made this difficult"
Cohesion: 0.40
...
### Community 248 - "User experience"
Cohesion: 0.50
Nodes (4): LadingLens document preflight, LadingLens evidence view, LadingLens inbox board, User experience

### Community 249 - "The three-account model"
Cohesion: 0.50
Nodes (4): Attachment account, Message account, Subject account, The three-account model

### Community 250 - "Hackathon scope"
Cohesion: 0.50
Nodes (4): Hackathon scope, SameStory final-round extensions, SameStory non-goals, SameStory preliminary core

### Community 251 - "workshop2-summary.md"
Cohesion: 0.50
Nodes (3): **Judging and Submission Information**, **Key Technical and Operational Guidance**, **Shipping Documentation Clarification**

### Community 252 - "_FakePersistence"
Cohesion: 0.29
Nodes (4): _FakePersistence, Category, UUID, _SuccessCall

### Community 254 - "Gate1Persistence"
Cohesion: 0.26
Nodes (5): Gate1Classifier, Gate1Persistence, Protocol, UUID, PersistedReceipt

### Community 255 - "Global Constraints"
Cohesion: 0.14
Nodes (13): Global Constraints, Task 16: Docs and graph, Task 17: Verification, Task 1: Workspace scope, Geist fonts and tokens, Task 2: Primitive skins, Task 3: The admincn shell, Task 4: Page header, Task 5: Upload page and the `/judge` entry (+5 more)

### Community 256 - "_TimingRoleDecider"
Cohesion: 0.22
Nodes (5): Times the product's real `JevDocumentRoleClient.decide()` call., _TimingRoleDecider, _role(), test_timing_role_decider_records_every_documents_request_id(), test_timing_role_decider_records_http_status_on_failure()

### Community 257 - "parametrize"
Cohesion: 0.32
Nodes (13): parametrize, test_qualified_label_is_not_read_as_the_compared_field(), test_txt_blank_label_does_not_take_a_label_line_below_it(), test_txt_blank_label_followed_by_an_unindented_label_stays_blank(), test_txt_blank_label_takes_its_value_from_the_indented_line_below(), test_txt_blank_label_takes_its_value_from_the_unindented_line_below(), test_txt_crlf_file_anchors_like_its_lf_twin(), test_txt_indented_segment_after_a_line_separator_continues_the_value() (+5 more)

### Community 258 - "Preflight"
Cohesion: 0.24
Nodes (10): _expands_past_cap(), _name(), _open_docx(), _open_xlsx(), Preflight, _preflight_pdf(), result(), Exception (+2 more)

### Community 259 - "AI in LadingLens"
Cohesion: 0.15
Nodes (13): AI in LadingLens, Limitations and production gates, Measured latency, Models and pinned versions, Prepared baseline versus live provider calls, Prompt and schema version registry, See also, The control-graph chat: grounded or refused (+5 more)

### Community 260 - "JevRoleDecision"
Cohesion: 0.20
...
### Community 261 - "review-queue-css.test.ts"
Cohesion: 0.33
Nodes (5): css, cssFiles, dir, tsx, tsxFiles

### Community 264 - "_both_keys_rate_limited"
Cohesion: 0.33
...
### Community 265 - "KeyAttempt"
Cohesion: 0.12
Nodes (22): GeminiExtractor, KeyAttempt, One Gemini call on one configured key, kept for the audit trail., FailingRoleDecider, UUID, rate_limited_then_succeeded_scan(), Shared PostgreSQL fixtures for building BL_READY comparison cases.…, Raises instead of deciding, like a Jev role-decision provider timeout. (+14 more)

### Community 266 - "fixtures.test.ts"
Cohesion: 0.32
Nodes (5): preparedControlGraph, REQUIRED_EMAILS, REQUIRED_KINDS, REQUIRED_SHIPMENTS, VALID_STATES

### Community 267 - "admincn tokens"
Cohesion: 0.40
Nodes (5): admincn colour tokens, admincn density, controls and shadows, admincn fonts, admincn radius, admincn tokens

### Community 268 - "DemoDataset.tsx"
Cohesion: 0.25
Nodes (7): DemoDataset(), DemoDatasetProps, reconciliationLabel(), SOURCE_LABEL, statusLabel(), SUMMARY, GateSummary

### Community 269 - "scripts"
Cohesion: 0.33
Nodes (6): scripts, build, dev, lint, preview, test

### Community 270 - "build_expected_shipments.py"
Cohesion: 0.42
Nodes (8): build_rows(), _case_row(), main(), _missing_case_row(), Write the prepared expected-shipment ledger from the synthetic bundle. The…, render_ledger(), _row(), test_committed_ledger_is_exactly_what_the_generator_writes()

### Community 271 - "Cloud deployment"
Cohesion: 0.22
...
### Community 272 - "reset_session"
Cohesion: 0.29
Nodes (8): create_session(), get, GuestDep, post, Request, ServicesDep, read_session(), reset_session()

### Community 273 - "ChatComposer"
Cohesion: 0.67
Nodes (3): ChatComposer(), onKeyDown(), submit()

### Community 276 - "CaseSnapshot"
Cohesion: 0.32
Nodes (8): _case_identifiers(), CaseSnapshot, _FrozenModel, _matching_namespaces(), BaseModel, _require_unique_inputs(), _reconcile(), SeedReconciliation

### Community 277 - "UploadPanel.test.tsx"
Cohesion: 0.29
Nodes (4): drop(), POLICY, zoneInput(), JudgePolicy

### Community 278 - "InboxBay.test.tsx"
Cohesion: 0.32
Nodes (4): byEmailId(), InboxBay(), OUTCOMES, ROWS

### Community 279 - "FAQ"
Cohesion: 0.29
Nodes (7): AI and Cloud Infrastructure Integration, Coding Challenges, FAQ, Problem-Solution Alignment, Scalability Plans, Success Metrics, User Feedback and Testing

### Community 280 - "PreflightError"
Cohesion: 0.67
Nodes (3): PreflightError, ValueError, Raised when a caller parses a document whose preflight did not pass.

## Knowledge Gaps
- **1301 isolated node(s):** `$schema`, `printWidth`, `singleQuote`, `semi`, `trailingComma` (+1296 more)
...
- **Why does `ComparedField` connect `ComparedField` to `parametrize`, `KeyAttempt`, `models.py`, `test_submission.py`, `graph_chat.py`, `test_document_analyzer.py`, `test_extraction.py`, `DocumentRole`, `test_comparison_persistence.py`, `test_pipeline.py`, `CaseReviewStatus`, `_xlsx_document`, `test_benchmark_latency.py`, `formats.py`, `seed_catalog.py`, `test_integration_matrix.py`, `label_field`, `run_benchmark`, `contracts.py`, `jev.py`, `_answer_not_in_the_text`, `test_submission_persistence.py`, `test_api_judge.py`, `test_contracts.py`, `persistence.py`, `test_formats.py`, `submission.py`, `comparison.py`, `SeedCatalog`, `test_jev_equivalence.py`, `PersistenceService`, `test_normalization.py`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `PersistenceService` connect `PersistenceService` to `KeyAttempt`, `models.py`, `test_submission.py`, `test_failure_matrix.py`, `test_api_evidence.py`, `ExtractionFailure`, `test_api_actions.py`, `test_api_reads.py`, `judge.py`, `test_comparison_persistence.py`, `test_pipeline.py`, `CaseReviewStatus`, `test_reconciliation_persistence.py`, `seed_catalog.py`, `InMemoryPrivateObjectStore`, `test_integration_matrix.py`, `ReconciliationOutcome`, `contracts.py`, `test_submission_persistence.py`, `test_api_judge.py`, `test_contracts.py`, `ComparedField`, `persistence.py`, `reconciliation.py`, `execute_gate_two`, `submission.py`, `comparison.py`, `SeedCatalog`, `deps.py`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `AuditContext` connect `PersistenceService` to `KeyAttempt`, `models.py`, `test_failure_matrix.py`, `ApiProblem`, `ExtractionFailure`, `test_reconciliation.py`, `test_api_actions.py`, `judge.py`, `ingestion.py`, `test_comparison_persistence.py`, `test_gate1.py`, `test_pipeline.py`, `CaseReviewStatus`, `test_reconciliation_persistence.py`, `InMemoryPrivateObjectStore`, `test_integration_matrix.py`, `contracts.py`, `test_submission_persistence.py`, `reconciliation.py`, `persistence.py`, `execute_gate_two`, `comparison.py`, `deps.py`, `_FakePersistence`, `Gate1Persistence`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Are the 98 inferred relationships involving `PersistenceService` (e.g. with `build_judge()` and `Services`) actually correct?**
  _`PersistenceService` has 98 INFERRED edges - model-reasoned connections that need verification._
- **Are the 129 inferred relationships involving `ComparedField` (e.g. with `_check_values()` and `compare_fields()`) actually correct?**
  _`ComparedField` has 129 INFERRED edges - model-reasoned connections that need verification._
- **Are the 94 inferred relationships involving `InMemoryPrivateObjectStore` (e.g. with `services()` and `client()`) actually correct?**
  _`InMemoryPrivateObjectStore` has 94 INFERRED edges - model-reasoned connections that need verification._
- **Are the 90 inferred relationships involving `SeedCatalog` (e.g. with `get_seed_catalog()` and `gate_summary()`) actually correct?**
  _`SeedCatalog` has 90 INFERRED edges - model-reasoned connections that need verification._