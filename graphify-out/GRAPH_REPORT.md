# Graph Report - docs-root-readme (2026-09-21)

## Corpus Check

- 353 files · ~511,021 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 52 file(s) not represented in the graph (top: .css 33, (none) 12, .lock 3)

## Summary

- 4380 nodes · 11523 edges · 222 communities (193 shown, 18 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1389 edges (avg confidence: 0.94)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `012b2b47`
...
Cohesion: 0.06
Nodes (38): AdmissionRecord, artifact_path(), _gemini_metadata(), _gemini_resolved_endpoint(), _git_short_sha(), _jev_metadata(), _jev_resolved_endpoint(), LiveAnalyzer (+30 more)
...
Cohesion: 0.10
Nodes (53): ComparisonPipeline, Compare a BL_READY case's SI/draft-BL pair and record the verdict., FailingRoleDecider, rate_limited_then_succeeded_scan(), Raises instead of deciding, like a Jev role-decision provider timeout., A scan read that only succeeds after the second key., _ambiguous_bl_case(), _answer_not_in_the_text() (+45 more)
...
Cohesion: 0.06
Nodes (34): AccessibleGraphTable(), EDGE_KIND_LABEL, KIND_LABEL, nodeKey(), STATE_LABEL, CanvasBoundary, CanvasBoundaryProps, ControlGraphView() (+26 more)

### Community 72 - "test_benchmark_latency.py"

Cohesion: 0.09
Nodes (36): build_artifact(), nearest_rank(), The nearest-rank quantile: rank = max(1, min(n, ceil(q * n))). Always an…, n/p50/p95/max per stage over non-warmup trials whose stage succeeded. Each…, Assemble the full JSON-serializable artifact for one benchmark run. `completed`…, Total/prompt/candidates token counts from a response's usage_metadata. None…, summarize(), _token_usage() (+28 more)
...
Cohesion: 0.05
Nodes (35): ThemeSeed(), HeroFilm(), Button(), ArtifactKey, DemoArtifacts(), DemoArtifactsProps, AppShell(), navLinkClass() (+27 more)

### Community 78 - "test_persistence.py"

Cohesion: 0.13
Nodes (50): AuditEventRecord, Base, CaseRecord, ClassificationAttempt, _created_at_column(), EmailReceipt, _enum(), ExpectedShipmentRecord (+42 more)

### Community 79 - "email-detail/types.ts"

Cohesion: 0.04
Nodes (55): ReviewHistoryEntry, EvidenceViewer(), EvidenceViewerProps, renderLocationDetails(), SCANNED_REGION_LABEL, HeldReviewCard(), detectedFilesLabel(), EmailDetailView() (+47 more)

### Community 80 - "sha256_hex"

Cohesion: 0.09
Nodes (17): artifact_object_key(), GcsPrivateObjectStore, private_object_key(), sha256_hex(), _validate_hash(), _validate_sha256(), asyncio, test_artifact_object_key_is_isolated_and_content_addressed() (+9 more)
...
Cohesion: 0.15
Nodes (33): EquivalenceJudge, PairAnalyzed, PairAnalyzer, Protocol, One trial's extraction stages. `analyses` is the product's real `(si, bl)`…, Run `warmup` discarded trials then `trials` measured ones, sequentially. Every…, run_benchmark(), _doc() (+25 more)
...
Cohesion: 0.17
Nodes (28): FieldVerdictRecord, SubmissionEvaluation, SubmissionRun, SubmissionRunRecord, CaseInput, InMemoryPrivateObjectStore, _validate_private_key(), _audit() (+20 more)
...
Cohesion: 0.08
Nodes (28): get_settings(), health(), lifespan(), FastAPI, get, JSONResponse, Response, Static files with fallback to index.html for client-side routes. (+20 more)
...
Cohesion: 0.06
Nodes (30): Field(), Scrollbar(), addDays(), addMonths(), ConfirmDialog(), ConfirmDialogProps, DatePicker(), onKeyDown() (+22 more)
...
Cohesion: 0.03
Nodes (105): Category, ComparisonGrid(), FieldVerdictRecord, TxtProvenance, FailurePanel(), FailurePanelProps, BL_DOC, SI_DOC (+97 more)
...
### Community 104 - "seed_catalog.py"

Cohesion: 0.12
Nodes (33): band(), compare_fields(), comparison_output(), _deterministic_reason(), equivalence_questions(), FieldDraft, needs_interactive_review(), resolve_verdicts() (+25 more)

### Community 105 - "comparison.py"

Cohesion: 0.17
Nodes (20): _check_values(), _diagnostic(), PairAdmission, Admit a valid SI/draft-BL pair and compare its seven fields. The SI is the…, An UNREADABLE diagnostic for one attachment, with its provenance., structural_output(), unreadable_document(), _values() (+12 more)

### Community 106 - "Controls.tsx"

Cohesion: 0.04
Nodes (56): ButtonProps, CheckboxProps, CheckboxState, FieldControlProps, FieldProps, FieldTriggerProps, DropZone(), onDrop() (+48 more)

### Community 107 - "ReceiptInput"

Cohesion: 0.33
Nodes (7): _receipt_input(), Copy one seed case into the guest workspace once; its ID there., AttachmentInput, receipt_request_hash(), ReceiptInput, _receipt(), test_receipt_request_hash_covers_exact_attachment_bytes()
...
Cohesion: 0.08
Nodes (49): ReviewActionRecord, SourceObject, AuditContext, CachedExtractionEntry, CacheWriteResult, _canonical_json(), _case_review_status(), CaseDocuments (+41 more)
...
### Community 138 - "UploadPanel.tsx"

Cohesion: 0.12
Nodes (15): Checkbox(), DropZoneRejection, extraFilesMessage(), formatCeiling(), formatFileSize(), humanize(), REJECTION_REASON_LABEL, rejectionMessage() (+7 more)
...
Cohesion: 0.05
Nodes (83): CaseActionBody, ExceptionActionBody, _named_reviewer(), BaseModel, GuestDep, MaterializerDep, post, Request (+75 more)
...
Cohesion: 0.18
Nodes (23): _payload_hash(), FailingEquivalence, Raises instead of judging, like a Jev equivalence provider timeout., _always_hangs(), _audit(), _create_workspace(), _FakeGeminiResponse, _FakeRoleDecider (+15 more)
...
Cohesion: 0.14
Nodes (10): ARCHIVO, { chromium }, README_DIR, require, styled, THEMES, tokenCss, WEB_DIR (+2 more)
...
Cohesion: 0.15
Nodes (15): GuestSessions, async_sessionmaker, AsyncSession, GuestSession, Workspace, client(), fixture, _audit() (+7 more)
...
Cohesion: 0.08
Nodes (46): _clients(), GeminiCallError, generate(), generate_traced(), KeyAttempt, Exception, One Gemini call on one configured key, kept for the audit trail., A failed Gemini call with every key attempt that preceded it. (+38 more)
...
Cohesion: 0.07
Nodes (62): APIError, ExtractedValue, ExtractionResult, _call_failure(), ExtractionCache, ExtractionFailure, ExtractionFailureCode, GeminiDocument (+54 more)

### Community 177 - "judge.py"

Cohesion: 0.12
Nodes (29): GuestContext, _check_errors(), JudgeService, _latency_ms(), _message_bytes(), datetime, Protocol, Request (+21 more)
...
### Community 179 - "deps.py"

Cohesion: 0.12
Nodes (18): build_judge(), build_services(), get_judge(), get_materializer(), get_services(), Request, SeedCatalogDep, ServicesDep (+10 more)
...
Cohesion: 0.22
Nodes (35): admit_pair(), ReviewReason, unreadable_provenance(), DocumentRole, _check(), _container_admission(), _corrupt(), _doc() (+27 more)
...
Cohesion: 0.21
Nodes (33): ReviewActionInput, build_bl_ready_case(), UUID, Shared PostgreSQL fixtures for building BL_READY comparison cases.…, Persist the given SI/BL attachments and classify the case BL_READY. Defaults to…, _audit_context(), _case_assignment_states(), _create_workspace() (+25 more)

### Community 185 - "JevProviderFailure"

Cohesion: 0.16
Nodes (7): _JevNotWired, Jev before its provider client is wired: every check fails closed., JevFailureCode, JevProviderFailure, StrEnum, A provider failure with safe context for persistence and retry policy., _FailingClassifier
...
Cohesion: 0.23
Nodes (11): ApiProblem, Exception, create_session(), get, GuestDep, post, Request, ServicesDep (+3 more)
...
### Community 193 - "_BundleDirectory"
...
Cohesion: 0.15
Nodes (14): _label_key(), parse_document(), PreflightError, ValueError, Raised when a caller parses a document whose preflight did not pass., Parse a preflighted TXT, XLSX, DOCX, or digital PDF locally., A label as the field patterns read it: NFKC, lower case, CJK removed,…, Test that block labels followed by colons are parsed correctly. (+6 more)

### Community 197 - "JevEquivalence"

Cohesion: 0.09
Nodes (12): JevEquivalence, JevRoleDecision, BaseModel, _DecidedRoles, Document roles read from the decisions, never presented as Jev output., _role_decision(), _role_decision(), _role_decision() (+4 more)
...
Cohesion: 0.36
Nodes (17): ReviewAssignmentRecord, ExpectedShipmentInput, _audit(), _create_case(), _create_workspace(), _missing_case(), asyncio, postgres (+9 more)
...
Cohesion: 0.25
Nodes (8): guest_reconciliation_id(), UUID, Copy-on-write: a guest's first action on a seed record copies it first. The…, Copy one seed reconciliation result into the guest workspace once. A run may…, This guest's copies of seed cases, keyed by seed email ID., This guest's reviewed seed exceptions, keyed by seed result ID., SeedMaterializer, ReconciliationExceptionState
...
- **1084 isolated node(s):** `$schema`, `printWidth`, `singleQuote`, `semi`, `trailingComma` (+1079 more)
...
- **Why does `PersistenceService` connect `PersistenceService` to `Category`, `test_document_role_persistence.py`, `submission.py`, `test_api_reads.py`, `test_failure_matrix.py`, `test_integration_matrix.py`, `test_api_actions.py`, `test_api_evidence.py`, `test_submission_bundle.py`, `test_api_judge.py`, `extraction.py`, `judge.py`, `deps.py`, `test_comparison_persistence.py`, `test_pipeline.py`, `SeedCatalog`, `test_reconciliation_persistence.py`, `test_persistence.py`, `InMemoryPrivateObjectStore`, `materialize.py`, `ComparedField`, `test_contracts.py`, `reconciliation.py`, `test_api_session.py`, `seed_catalog.py`, `comparison.py`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `ComparedField` connect `ComparedField` to `Category`, `test_document_role_persistence.py`, `test_api_reads.py`, `submission.py`, `build_seed_decisions.py`, `test_integration_matrix.py`, `test_document_analyzer.py`, `contracts.py`, `test_api_judge.py`, `extraction.py`, `DocumentRole`, `test_comparison_persistence.py`, `test_pipeline.py`, `SeedCatalog`, `parse_document`, `JevEquivalence`, `test_benchmark_latency.py`, `formats.py`, `test_persistence.py`, `_FakeEquivalence`, `run_benchmark`, `jev.py`, `InMemoryPrivateObjectStore`, `test_contracts.py`, `test_jev_equivalence.py`, `seed_catalog.py`, `comparison.py`, `PersistenceService`, `test_normalization.py`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `DocumentRole` connect `DocumentRole` to `test_failure_matrix.py`, `build_seed_decisions.py`, `test_integration_matrix.py`, `test_document_analyzer.py`, `test_submission_bundle.py`, `benchmark_latency.py`, `test_api_judge.py`, `extraction.py`, `test_comparison_persistence.py`, `JevProviderFailure`, `test_pipeline.py`, `SeedCatalog`, `JevEquivalence`, `test_benchmark_latency.py`, `run_benchmark`, `jev.py`, `seed_catalog.py`, `comparison.py`, `JevDocumentRoleClient`?**
