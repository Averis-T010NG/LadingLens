...
## Corpus Check
- 279 files · ~364,016 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 49 file(s) not represented in the graph (top: .css 30, (none) 12, .lock 3)

## Summary
- 3135 nodes · 7446 edges · 186 communities (157 shown, 20 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 818 edges (avg confidence: 0.94)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe9a49b8`
...
Cohesion: 0.17
Nodes (20): AmbiguousReconciliation, _ContractModel, DocxParagraphLocation, DocxProvenance, DocxTableLocation, MissingCaseReconciliation, _ProvenanceIdentity, BaseModel (+12 more)

### Community 19 - "generate_traced"
Cohesion: 0.24
Nodes (17): generate(), generate_traced(), Call Gemini; only a 429 moves the same request to the second key. Pass a…, Call Gemini, retrying once on the second key if the first is rate-limited., _client(), asyncio, _rate_limited(), test_falls_back_to_second_key_on_429() (+9 more)
...
Cohesion: 0.10
Nodes (52): Status, GeminiExtractor, KeyAttempt, One Gemini call on one configured key, kept for the audit trail., ComparisonPipeline, Compare a BL_READY case's SI/draft-BL pair and record the verdict., test_timed_out_call_still_reports_completed_key_attempts(), rate_limited_then_hangs() (+44 more)
...
Cohesion: 0.05
Nodes (130): admit_pair(), band(), _check_values(), compare_fields(), comparison_output(), _deterministic_reason(), _diagnostic(), equivalence_questions() (+122 more)
...
Cohesion: 0.09
Nodes (43): DigitalPdfLocation, DigitalPdfProvenance, XlsxLocation, XlsxProvenance, _cell_text(), _docx_row_field(), _docx_value_row(), FieldCandidate (+35 more)
...
Cohesion: 0.13
Nodes (34): ExtractionFailure, ExtractionFailureCode, GeminiDocument, Exception, StrEnum, A fail-closed extraction outcome that must surface as retry or review., scan_extraction(), _answer() (+26 more)
...
Cohesion: 0.16
Nodes (14): ExtractionResult, ExtractionCache, GeminiField, GeminiFields, grounded_extraction(), local_extraction(), _ordered(), BaseModel (+6 more)

### Community 78 - "InMemoryPrivateObjectStore"
Cohesion: 0.17
Nodes (39): AuditEventRecord, CaseRecord, EmailReceipt, ExtractionCache, IngestionRequest, receipt_request_hash(), ReceiptInput, ReviewAssignmentInput (+31 more)
...
Cohesion: 0.10
Nodes (53): ComparedField, parse_document(), Parse a preflighted TXT, XLSX, DOCX, or digital PDF locally., test_local_extraction_keeps_local_anchors(), _docx_document(), _only(), _parse(), _pdf_document() (+45 more)
...
Cohesion: 0.12
Nodes (33): _canonical_hash(), _canonical_ids(), compute_subject_key(), Provenance, ReconciliationResult, parametrize, _reconciliation_base(), test_ambiguous_subject_key_canonicalizes_both_candidate_sets() (+25 more)
...
Cohesion: 0.23
Nodes (12): get_settings(), get_engine(), get_session(), AsyncEngine, AsyncSession, _clients(), GeminiNotConfigured, RuntimeError (+4 more)
...
Cohesion: 0.14
Nodes (17): InboxIngestionService, Receipt an inbox before running fail-closed Gate 1 classification., JevClassification, _audit(), _FakePersistence, _IncompleteClassifier, _load_organizer_inbox(), _MemoryInbox (+9 more)
...
Cohesion: 0.29
Nodes (4): RoleDecider, JevRoleDecision, BaseModel, model_validator
...
Cohesion: 0.09
Nodes (39): EvaluatorOutput, serialize_evaluator_output(), ClassificationAttempt, AuditContext, CachedExtractionEntry, CacheWriteResult, _canonical_json(), CaseDocuments (+31 more)
...
Cohesion: 0.08
Nodes (28): ThemeSeed(), HeroFilm(), Button(), Field(), Select(), SelectOption, AppShell(), SiteFooter() (+20 more)
...
Cohesion: 0.37
Nodes (17): DocumentRoleDecisionRecord, EmailAttachment, SourceObject, _decision(), asyncio, parametrize, postgres, _receipt() (+9 more)

### Community 140 - "PrivateObjectStore"
Cohesion: 0.25
...
Cohesion: 0.23
Nodes (20): AttachmentInput, DocumentAnalyzer, _Cache, _Gemini, _input(), asyncio, parametrize, _Roles (+12 more)
...
Cohesion: 0.29
Nodes (7): _restamp(), _name(), Preflight, _preflight_pdf(), result(), Exception, Hash, size, and identify bytes; reject unsupported or corrupt files.
...
### Community 171 - "_label_key"
Cohesion: 0.67
Nodes (4): _label_key(), A label as the field patterns read it: NFKC, lower case, CJK removed,…, test_label_patterns_map_the_bundle_label_keys_as_recorded(), recording_label_field()
...
- **Why does `PersistenceService` connect `PersistenceService` to `CaseReviewStatus`, `test_document_role_persistence.py`, `PrivateObjectStore`, `extraction.py`, `InMemoryPrivateObjectStore`, `submission.py`, `models.py`, `ComparedField`, `test_submission_persistence.py`, `test_pipeline.py`, `Category`, `test_comparison_persistence.py`, `test_contracts.py`, `reconciliation.py`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `ComparedField` connect `ComparedField` to `test_document_role_persistence.py`, `submission.py`, `contracts.py`, `test_pipeline.py`, `models.py`, `test_submission_persistence.py`, `Category`, `test_document_analyzer.py`, `jev.py`, `.defect_fields_are_unique_and_canonical`, `_label_key`, `test_comparison_persistence.py`, `formats.py`, `test_extraction.py`, `test_jev_equivalence.py`, `extraction.py`, `test_contracts.py`, `CaseReviewStatus`, `PersistenceService`, `.locate`?**
