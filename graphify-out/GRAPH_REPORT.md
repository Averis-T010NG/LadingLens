...
## Corpus Check
- 145 files · ~159,891 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1184 nodes · 1573 edges · 92 communities (80 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `461d6b90`
...
9. `EmailDetailRecord` - 14 edges
10. `Demo Production Tooling Design` - 14 edges
...
Cohesion: 0.07
Nodes (47): AmbiguousReconciliation, CaseReviewAction, CaseReviewTarget, ExpectedShipment, MissingCaseReconciliation, ReconciliationBase, ReconciliationExceptionActionType, ReconciliationExceptionReviewAction (+39 more)
...
Cohesion: 0.16
Nodes (11): ReviewHistoryEntry, PREPARED_FIXTURES, cloneRecord(), createPreparedEmailDetailService(), ACTION_TO_STATE, createPreparedReviewQueueService(), defaultReviewQueueService, ReviewQueueService (+3 more)
...
Cohesion: 0.07
Nodes (35): plugins, rules, react/only-export-components, react/rules-of-hooks, $schema, App(), ThemeSeed(), HeroFilm() (+27 more)
...
Cohesion: 0.17
Nodes (12): Decision ownership, Evaluator contract, Functional requirements, Goals and boundaries, Goals and measurable success, Human review and provenance, Non-goals, Problem and users (+4 more)
...
### Community 60 - "Overlays.tsx"
Cohesion: 0.05
Nodes (25): addMonths(), DatePicker(), DatePickerProps, Menu(), MenuItem(), MenuItemProps, MenuProps, MONTH_NAMES (+17 more)
...
Cohesion: 0.19
Nodes (8): detectedFilesLabel(), EmailDetailView(), EmailDetailViewProps, STATUS_KIND_MAP, useEmailDetailRecord(), defaultEmailDetailService, EmailDetailService, CaseReviewActionInput
...
Cohesion: 0.05
Nodes (48): ButtonProps, CheckboxProps, CheckboxState, FieldControlProps, FieldProps, FieldTriggerProps, DropZone(), DropZoneProps (+40 more)
...
### Community 83 - "dataset-bundle.md"
Cohesion: 0.40
...
### Community 88 - "Problem statement and datasets Drive folder"
Cohesion: 0.50
Nodes (3): File descriptions, Folder files, Problem statement and datasets Drive folder

### Community 90 - "Scope by round"
Cohesion: 0.67
Nodes (3): Finals scope, Preliminary scope, Scope by round

## Knowledge Gaps
- **663 isolated node(s):** `$schema`, `printWidth`, `singleQuote`, `semi`, `trailingComma` (+658 more)
...
- **Why does `react` connect `routes.tsx` to `EmailDetailView.tsx`, `Overlays.tsx`, `EvidenceViewer.tsx`, `Controls.tsx`?**
...
- **Why does `ReviewReason` connect `Controls.tsx` to `contracts.ts`, `email-detail/types.ts`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
